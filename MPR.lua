...
local spellsCastOnTarget = {"Mano de protección", "Estimular", "Tranquilidad", "Piel de corteza", "Instintos de supervivencia", "Defensor candente", "Protección divina", "Escudo divino"}
...
--| Filter: UnitIsPlayer(Target)
local aurasAppliedOnTarget = {"Volatile Ooze Adhesive", "Gaseous Bloat", "Unbound Plague", "Soul Consumption", "Fiery Combustion", "Piel de corteza", "Instintos de supervivencia", "Égida de Dalaran", "Defensa iracunda", "Amplificar magia"}
